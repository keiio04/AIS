...
<div class="card" style="text-align: center; padding: 4rem 2rem;">
    ...
    <h3 style="color: var(--text-muted); margin-bottom: 0.5rem;">Trash Bin is Empty</h3>
    <p style="color: var(--text-muted); font-size: 0.9rem;">No deleted journal entries found. Items moved to trash will appear here.</p>
    <a href="journal_entries.php" class="btn btn-primary" style="margin-top: 1.5rem;">Go to Journal Entries</a>
</div>
