...
<div class="layout">
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
                ...
                <div id="biz_type" class="nav-subitems collapse-smooth">
                    ...
                    <div style="border: 1px solid rgba(59, 130, 246, 0.4); border-radius: 8px; padding: 0.5rem; margin-bottom: 0.5rem; background: rgba(59, 130, 246, 0.1);">
                        ...
                        <div id="modules_<?= $bt ?>" class="collapse-smooth" style="padding-left: 0.5rem; margin-top: 0.5rem;">
                            <a href="<?= BASE_URL ?>pages/journal_entries.php" class="nav-subitem <?= $current_page==='journal_entries'?'active':'' ?>" style="padding: 0.25rem 0.5rem;">
            ...
            <div style="padding: 0 0.75rem; margin-top: 1rem; pointer-events: <?= $activeCompanyId ? 'auto' : 'none' ?>; opacity: <?= $activeCompanyId ? '1' : '0.5' ?>;">
                <a href="<?= BASE_URL ?>pages/trash_bin.php" class="nav-item <?= $current_page==='trash_bin'?'active':'' ?>" style="color: #ef4444;">
