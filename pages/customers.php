        ...
        <div class="modal-body" style="padding: 1rem 1.25rem; max-height: 72vh; overflow-y: auto;">
            ...
            <div id="historyContent" style="display: none;">
                <h3 style="font-size: 0.85rem; font-weight: 700; color: var(--text-primary); margin: 0 0 0.5rem; display: flex; align-items: center; gap: 0.4rem;">
                    <i data-lucide="file-text" style="width: 14px; height: 14px; color: var(--primary-color);"></i> Sales Invoices
                </h3>
...
function openHistoryModal(customerId, customerLabel) {
    ...
    fetch('customer_history_api.php?id=' + encodeURIComponent(customerId))
        ...
        .then(data => {
            ...
            renderHistoryRows('historyInvoiceRows', data.invoices, false);
            renderHistoryRows('historyPaymentRows', data.payments, true);
            if (window.lucide) lucide.createIcons();
        })
        .catch(() => {
            document.getElementById('historyLoading').style.display = 'none';
