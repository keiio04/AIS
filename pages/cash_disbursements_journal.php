...
$saveError = journal_vat_save($db, [
    ...
    'journal_id' => 'CDJ',
    'reference_prefix' => 'CDJ',
    'vat_mode' => 'input',
    'redirect' => 'cash_disbursements_journal.php',
], $accountsList, $companyIsTaxRegistered);
if ($saveError !== null) {
    $error = $saveError;
}

journal_vat_delete($db, (int)$company_id, 'CDJ', 'cash_disbursements_journal.php', 'Cash Disbursements Journal');
...
function onAccountSearchInput(inputEl) {
    ...
    tr.querySelector('.account-id-…431 tokens truncated… = 'none'; }
}
